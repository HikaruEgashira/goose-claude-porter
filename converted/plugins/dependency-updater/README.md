...
- **project_path** (string)
  Path to the project directory to check for dependencies

- **update_mode** (string)
  Mode of operation: 'report' (default) to only report outdated dependencies, 'suggest' to suggest update commands, 'interactive' to prompt before suggesting updates

- **package_filter** (string)
  Optional filter to check specific packages only (comma-separated list, e.g., 'react,lodash')
