---
name: generate-change-logs-from-git-commits
...
- **start_sha** (string, required): the start sha of the git commits
- **end_sha** (string, required): the end sha of the git commits


## Example Usage

```
/generate-change-logs-from-git-commits `start_sha=value`, `end_sha=value`
```
