...
```bash
/plugin install statistical-analyzer
```
...
- **data_file** (string, required)
  Path to the cleaned data file to analyze

- **confidence_level** (string)
  Confidence level for statistical tests (90, 95, 99)

- **include_correlations** (string)
  Whether to compute correlation matrix (true/false)
