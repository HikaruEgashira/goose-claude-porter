...
```bash
/plugin install smart-task-organizer
```
...
- **source_type** (string, required)
  Type of source to scan: files, emails, messages, notes, all

- **priority_level** (string)
  Filter by priority: urgent, high, medium, low, all

- **project_filter** (string)
  Filter tasks by specific project name
