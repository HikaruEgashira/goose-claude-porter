...
```bash
/plugin install dev-guide-migration-from-a-specific-file-or-files-in-a-directory
```
...
- **source_file** (file, required)
  the source file(s) or the folder to migrate

- **target_folder** (file, required)
  the target folder to migrate

- **example_file** (file, required)
  the example file to follow the doc format

- **sidebar_file** (file, required)
  the sidebar file to add the new doc page
