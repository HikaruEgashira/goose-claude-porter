...
- **fqn** (string, required): The fully qualified name of the asset in openmetadata you'd like an agent to act on


## Example Usage

```
/use-openmetadata `fqn=value`
```
