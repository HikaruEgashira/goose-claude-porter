...
Automatically clean up all references of a fully rolled out feature flag from a codebase and make the new behavior the default.
...
- **feature_flag_key** (string, required): Key of the feature flag
- **repo_dir** (string): Directory of the codebase


## Example Usage

```
/clean-up-feature-flag `feature_flag_key=value`, `repo_dir=./`
```
